...
module.exports = class extends Command {
    ...
    async execute(message, args) {
        ...
        const noUserEmbed = new MessageEmbed({
            color: 'RED',
            description: `${message.member} <a:egp_no:935209428070854717> Who do you want to bark for?`
        });
        ...
        const hugEmbed = new MessageEmbed({
            color: 'RANDOM',
            description: `${message.member} **barked for** {user}!`
        });
